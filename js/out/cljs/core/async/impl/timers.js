...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write(writer__4218__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_25127 = (0);while(true){
if((i_25127 < arr.length))
{(arr[i_25127] = null);
{
var G__25128 = (i_25127 + (1));
i_25127 = G__25128;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write(writer__4218__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_25140 = (self__.level + (1));while(true){
if((i_25140 <= (new_level + (1))))
{(update[i_25140] = self__.header);
{
var G__25141 = (i_25140 + (1));
i_25140 = G__25141;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_25142 = (0);while(true){
if((i_25142 <= self__.level))
{var links_25143 = (update[i_25142]).forward;if(((links_25143[i_25142]) === x__$1))
{(links_25143[i_25142] = (x__$1.forward[i_25142]));
{
var G__25144 = (i_25142 + (1));
i_25142 = G__25144;
continue;
}
} else
{{
var G__25145 = (i_25142 + (1));
i_25142 = G__25145;
continue;
}
}
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3640__auto__,timeout__$1,me){
